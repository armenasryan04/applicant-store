...
import com.samplemission.collectcvsfromgoogledrive.security.CurrentUser;
...
public class UserEndpoint {
    ...
    public ResponseEntity<UserAuthResponseDto> auth(@RequestBody UserAuthRequestDto userDto) {
        Optional<ResponsibleHr> user = responsibleHrRepository.findByUsernameOrEmail(userDto.getUsername(), userDto.getUsername());
        if (user.isEmpty()) {
    ...
    public ResponseEntity<ResponsibleHrForRegistrationDto> register(@RequestBody ResponsibleHrForRegistrationDto responsibleHrDto) {
        Optional<ResponsibleHr> byEmail = responsibleHrRepository.findByUsernameOrEmail(responsibleHrDto.getUsername(), responsibleHrDto.getEmail());
    ...
    public ResponseEntity<CurrentUser> getResponsible(@AuthenticationPrincipal CurrentUser currentUser) {
